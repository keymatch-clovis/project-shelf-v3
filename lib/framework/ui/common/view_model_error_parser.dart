...
extension ViewModelErrorParser on List<ViewModelError> {
  ...
  return map((error) {
    return switch(error) {
      ...
      ViewModelError.invalidDecimalValue => localizations.err_invalid_decimal_value,
      ViewModelError.invalidIntegerValue => localizations.err_invalid_integer_value,
      ViewModelError.negativeValue => localizations.err_negative_value,
      ViewModelError.notEnoughProductStock => localizations.err_not_enough_stock,
