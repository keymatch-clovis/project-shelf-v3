...
mixin _$CreateInvoiceProductState {
 ...
 ObjectInput<ProductDto> get productInput; Input get quantityInput; Input get unitPriceInput;
...
@override
int get hashCode => Object.hash(runtimeType,productInput,quantityInput,unitPriceInput);

@override
String toString() {
  return 'CreateInvoiceProductState(productInput: $productInput, quantityInput: $quantityInput, unitPriceInput: $unitPriceInput)';
}
...
@useResult
$Res call({
 ObjectInput<ProductDto> productInput, Input quantityInput, Input unitPriceInput
});
...
/// Create a copy of CreateInvoiceProductState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? productInput = null,Object? quantityInput = null,Object? unitPriceInput = null,}) {
  return _then(_self.copyWith(
productInput: null == productInput ? _self.productInput : productInput // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ObjectInput<ProductDto> productInput,  Input quantityInput,  Input unitPriceInput)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateInvoiceProductState() when $default != null:
return $default(_that.productInput,_that.quantityInput,_that.unitPriceInput);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ObjectInput<ProductDto> productInput,  Input quantityInput,  Input unitPriceInput)  $default,) {final _that = this;
switch (_that) {
case _CreateInvoiceProductState():
return $default(_that.productInput,_that.quantityInput,_that.unitPriceInput);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ObjectInput<ProductDto> productInput,  Input quantityInput,  Input unitPriceInput)?  $default,) {final _that = this;
switch (_that) {
case _CreateInvoiceProductState() when $default != null:
return $default(_that.productInput,_that.quantityInput,_that.unitPriceInput);case _:
  return null;
...
class _CreateInvoiceProductState implements CreateInvoiceProductState {
  const _CreateInvoiceProductState({required this.productInput, required this.quantityInput, required this.unitPriceInput});
...
/// Create a copy of CreateInvoiceProductState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? productInput = null,Object? quantityInput = null,Object? unitPriceInput = null,}) {
