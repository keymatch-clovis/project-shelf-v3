...
mixin _$EditCompanyInfoState {
 ...
 CompanyInfoDto get companyInfo; Input<Uint8List> get logoBytes; Input<String> get companyName; Input<String> get companyDocument; Input<String> get companyEmail; Input<String> get companyPhone;
...
@override
int get hashCode => Object.hash(runtimeType,companyInfo,logoBytes,companyName,companyDocument,companyEmail,companyPhone);

@override
String toString() {
  return 'EditCompanyInfoState(companyInfo: $companyInfo, logoBytes: $logoBytes, companyName: $companyName, companyDocument: $companyDocument, companyEmail: $companyEmail, companyPhone: $companyPhone)';
}
...
@useResult
$Res call({
 CompanyInfoDto companyInfo, Input<Uint8List> logoBytes, Input<String> companyName, Input<String> companyDocument, Input<String> companyEmail, Input<String> companyPhone
});
...
/// Create a copy of EditCompanyInfoState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? companyInfo = null,Object? logoBytes = null,Object? companyName = null,Object? companyDocument = null,Object? companyEmail = null,Object? companyPhone = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CompanyInfoDto companyInfo,  Input<Uint8List> logoBytes,  Input<String> companyName,  Input<String> companyDocument,  Input<String> companyEmail,  Input<String> companyPhone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EditCompanyInfoState() when $default != null:
return $default(_that.companyInfo,_that.logoBytes,_that.companyName,_that.companyDocument,_that.companyEmail,_that.companyPhone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CompanyInfoDto companyInfo,  Input<Uint8List> logoBytes,  Input<String> companyName,  Input<String> companyDocument,  Input<String> companyEmail,  Input<String> companyPhone)  $default,) {final _that = this;
switch (_that) {
case _EditCompanyInfoState():
return $default(_that.companyInfo,_that.logoBytes,_that.companyName,_that.companyDocument,_that.companyEmail,_that.companyPhone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CompanyInfoDto companyInfo,  Input<Uint8List> logoBytes,  Input<String> companyName,  Input<String> companyDocument,  Input<String> companyEmail,  Input<String> companyPhone)?  $default,) {final _that = this;
switch (_that) {
case _EditCompanyInfoState() when $default != null:
return $default(_that.companyInfo,_that.logoBytes,_that.companyName,_that.companyDocument,_that.companyEmail,_that.companyPhone);case _:
  return null;
...
class _EditCompanyInfoState implements EditCompanyInfoState {
  const _EditCompanyInfoState({required this.companyInfo, required this.logoBytes, required this.companyName, required this.companyDocument, required this.companyEmail, required this.companyPhone});
...
/// Create a copy of EditCompanyInfoState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? companyInfo = null,Object? logoBytes = null,Object? companyName = null,Object? companyDocument = null,Object? companyEmail = null,Object? companyPhone = null,}) {
